...
if __name__ == "__main__":
    ...
    plot_costs(minibatch_costs, train_costs, validation_costs, num_iterations, num_batches, "net1_cost.png")
    plot_accuracys(train_accuracies, validation_accuracies, num_iterations, "net1_acc.png")