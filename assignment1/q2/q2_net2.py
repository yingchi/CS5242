...
if __name__ == "__main__":
    ...
    (num_batches, minibatch_costs, train_costs, validation_costs, train_accuracies, validation_accuracies) = \
        train_minibatch_SGD(X_train, T_train, X_validation, T_validation, layers, learning_rate=0.002)
    num_iterations = len(train_costs)

    plot_costs(minibatch_costs, train_costs, validation_costs, num_iterations, num_batches, "net2_cost.png")
    plot_accuracys(train_accuracies, validation_accuracies, num_iterations, "net2_acc.png")
